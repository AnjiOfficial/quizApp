...
if(!empty($_SESSION['name'])){
  ...
  // echo $query;exit;
   ...
   mysql_query("update users set score='$right_answer' where user_name='$name'");
	mysql_query("insert into studentmarks (name,score) values ('$name','$right_answer')");
?>
<!DOCTYPE html>
<html>
    <head>
           ...
           <div class="row"> 
                  <div class="col-xs-18 col-sm-9 col-lg-9"> 
                    <div class='result-logo1'>
						  ...
						  <a href="<?php echo 'sol.php';?>" class='btn btn-success'>VIEW answers</a>
                    </div>
                  </div>
			  
                  <div class="col-xs-6 col-sm-3 col-lg-3"> 
                     <a href="<?php echo 'index.php';?>" class='btn btn-success'>Start new Quiz!!!</a>                   
